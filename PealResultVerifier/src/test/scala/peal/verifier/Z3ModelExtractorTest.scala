...
class Z3ModelExtractorTest extends ShouldMatchersForJUnit {
  ...
  def testCanExtractSimpleModel() {
    ...
    Z3ModelExtractor.extractAssignments(model)("name1") should be(Map("q1" -> PealFalse, "q2" -> PealFalse, "q3" -> PealFalse, "cond1" -> PealFalse, "always_true_name1" -> PealFalse))
  }
  ...
  def testCanExtractBrokenModel() {
    ...
    Z3ModelExtractor.extractAssignments(model)("analysis1") should be(Map("cond2" -> PealFalse, "always_true_analysis1" -> PealFalse, "cond1" -> PealFalse))
  }
  ...
  def testCanExtractModelFromExtendedSynthesis() {
    ...
    val assignments = Z3ModelExtractor.extractAssignments(model)("name1")
    println(assignments)
  }
}
