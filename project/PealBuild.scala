...
object PealBuild extends Build {
  ...
  lazy val root = Project(id = "PealApp-lift", base = file(".")) aggregate (generator, domain, parser, synthesiser) dependsOn(generator, domain, parser, synthesiser)
  ...
  lazy val generator = Project(id = "PealModelGenerator", base = file("PealModelGenerator")) dependsOn (parser, domain)
