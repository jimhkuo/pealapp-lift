...
Assuming sbt is installed on your path, and you have obtained PealApp-lift source, you can do the following
actions. From PealApp-lift directory on the command line,
...
3. sbt assembly
(This creates the PealApp jar file in target directory, the version number of the jar is defined in build.sbt)
