...
class PealProgramParserTest extends ShouldMatchersForJUnit with Z3ModelMatcher {
  ...
  def testUnclaredThrowExceptionGreaterThanpSetCatchLhsFirst() {
    ...
    ex.getMessage should be ("pSet1 is not declared in cond1 = pSet1 < pSet2")
  }
  ...
  def testUnclaredThrowExceptionLessThanNum() {
    ...
    ex.getMessage should be ("pSet1 is not declared in cond1 = pSet1 <= 0")
  }
  ...
  def testUnclaredThrowExceptionLessThanpSetLhsFirst() {
    ...
    ex.getMessage should be ("pSet2 is not declared in cond1 = pSet2 <= pSet1")
  }
  ...
  def testUnclaredThrowExceptionNotCondition() {
    ...
    ex.getMessage should be ("cond2 is not declared in cond3 = !cond2")
  }
  ...
  def testUnclaredThrowExceptionAndLhs() {
    ...
    ex.getMessage should be ("cond2 is not declared in cond3 = cond2 && cond1")
  }
  ...
  def testUnclaredThrowExceptionAndRhs() {
    ...
    ex.getMessage should be ("cond2 is not declared in cond3 = cond1 && cond2")
  }
