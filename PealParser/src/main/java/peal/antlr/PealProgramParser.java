		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					catchError(pSets, (id0!=null?id0.getText():null) + " = " + (id2!=null?id2.getText():null) + " <= " + (num!=null?num.getText():null) , (id2!=null?id2.getText():null)); Condition cond = new LessThanThCondition(pSets.get((id2!=null?id2.getText():null)), new Left<BigDecimal,PolicySet>(BigDecimal.valueOf(Double.valueOf((num!=null?num.getText():null))))); conds.put((id0!=null?id0.getText():null), cond);
					}
					break;
				case 2 :
				...
				case 3 :
					...
					catchError(pSets, (id0!=null?id0.getText():null) + " = " + (num!=null?num.getText():null) + " < " + (id2!=null?id2.getText():null), (id2!=null?id2.getText():null)); Condition cond = new GreaterThanThCondition(pSets.get((id2!=null?id2.getText():null)), new Left<BigDecimal,PolicySet>(BigDecimal.valueOf(Double.valueOf((num!=null?num.getText():null))))); conds.put((id0!=null?id0.getText():null), cond);
					}
					break;
				case 4 :
					...
					catchError(pSets, (id0!=null?id0.getText():null) + " = " + (id3!=null?id3.getText():null) + " < " + (id2!=null?id2.getText():null), (id3!=null?id3.getText():null), (id2!=null?id2.getText():null)); Condition cond = new GreaterThanThCondition(pSets.get((id2!=null?id2.getText():null)), new Right<BigDecimal,PolicySet>(pSets.get((id3!=null?id3.getText():null)))); conds.put((id0!=null?id0.getText():null), cond);
					}
					break;
				case 5 :
				...
				case 7 :
					...
					catchError(conds, (id0!=null?id0.getText():null) + " = " + (id1!=null?id1.getText():null) + " || " + (id2!=null?id2.getText():null), (id1!=null?id1.getText():null), (id2!=null?id2.getText():null)); Condition cond = new OrCondition((id1!=null?id1.getText():null), (id2!=null?id2.getText():null)); conds.put((id0!=null?id0.getText():null), cond);
					}
					break;
				case 8 :
