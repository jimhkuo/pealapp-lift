...
public class Z3OutputParser extends Parser {
				...
				case 3 :
					...
					while (true) {
						...
						if ( (LA11_0==16) ) {
							...
							if ( ((LA11_1 >= IDENT && LA11_1 <= NUMBER)||LA11_1==9||(LA11_1 >= 11 && LA11_1 <= 13)||(LA11_1 >= 16 && LA11_1 <= 18)||(LA11_1 >= 20 && LA11_1 <= 23)) ) {
								alt11=1;
							}

						}
						else if ( ((LA11_0 >= IDENT && LA11_0 <= NUMBER)||LA11_0==9||(LA11_0 >= 17 && LA11_0 <= 18)||(LA11_0 >= 20 && LA11_0 <= 23)) ) {
							alt11=1;
						}
						...
						case 1 :
							...
							{
							if ( (input.LA(1) >= IDENT && input.LA(1) <= NUMBER)||input.LA(1)==9||(input.LA(1) >= 16 && input.LA(1) <= 18)||(input.LA(1) >= 20 && input.LA(1) <= 23) ) {
								input.consume();
		...
		try {
			...
			switch (alt15) {
				case 1 :
					...
					{
					IDENT3=(Token)match(input,IDENT,FOLLOW_IDENT_in_value343); 
				...
				case 2 :
					...
					{
					NUMBER4=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_value350); 
				...
				case 3 :
					...
					{
					match(input,9,FOLLOW_9_in_value357); 
					match(input,19,FOLLOW_19_in_value359); 
					pushFollow(FOLLOW_unary_in_value361);
					unary5=unary();
					state._fsp--;

					match(input,16,FOLLOW_16_in_value363); 
					s = "-" + unary5;
					}
					break;
				case 4 :
					...
					{
					match(input,9,FOLLOW_9_in_value370); 
					match(input,20,FOLLOW_20_in_value372); 
					lhs=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_value376); 
					rhs=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_value380); 
					match(input,16,FOLLOW_16_in_value382); 
				...
				case 5 :
					...
					{
					match(input,9,FOLLOW_9_in_value389); 
					match(input,IDENT,FOLLOW_IDENT_in_value390); 
					...
					switch (alt14) {
						case 1 :
							...
							{
							match(input,9,FOLLOW_9_in_value393); 
							...
							while (true) {
								...
								case 1 :
									...
									{
									match(input,IDENT,FOLLOW_IDENT_in_value396); 
									}
									break;
					...
					match(input,16,FOLLOW_16_in_value403); 
					s = "";
					}
					break;
				case 6 :
					...
					{
					match(input,14,FOLLOW_14_in_value410); 
					pushFollow(FOLLOW_component_in_value412);
					component();
					state._fsp--;

					pushFollow(FOLLOW_component_in_value414);
					component();
					state._fsp--;

					pushFollow(FOLLOW_component_in_value416);
					component();
					state._fsp--;

					match(input,16,FOLLOW_16_in_value418); 
					s = "";
					}
					break;
		...
		try {
			...
			switch (alt17) {
				case 1 :
					...
					{
					match(input,9,FOLLOW_9_in_component434); 
					match(input,23,FOLLOW_23_in_component435); 
					match(input,IDENT,FOLLOW_IDENT_in_component437); 
					pushFollow(FOLLOW_value_in_component439);
					value();
					state._fsp--;

					match(input,16,FOLLOW_16_in_component440); 
					}
					break;
				case 2 :
					// /Users/jkuo/PealApp-lift/antlr/Z3Output.g:76:4: '(and' ( component )+ ')'
					{
					match(input,10,FOLLOW_10_in_component447); 
					...
					while (true) {
						...
						case 1 :
							...
							{
							pushFollow(FOLLOW_component_in_component450);
							component();
							state._fsp--;
					...
					match(input,16,FOLLOW_16_in_component454); 
					}
					break;
				case 3 :
					// /Users/jkuo/PealApp-lift/antlr/Z3Output.g:77:4: value
					{
					pushFollow(FOLLOW_value_in_component459);
					value();
					state._fsp--;
		...
		try {
			...
			switch (alt18) {
				case 1 :
					...
					{
					IDENT6=(Token)match(input,IDENT,FOLLOW_IDENT_in_unary476); 
				...
				case 2 :
					...
					{
					NUMBER7=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_unary483); 
				...
				case 3 :
					...
					{
					pushFollow(FOLLOW_value_in_unary490);
					value8=value();
					state._fsp--;
	...
	public final void error() throws RecognitionException {
		try {
			...
			{
			match(input,Z3ERROR,FOLLOW_Z3ERROR_in_error503); 
			}
	...
	public static final BitSet FOLLOW_13_in_assignment280 = new BitSet(new long[]{0x0000000000F70232L});
	public static final BitSet FOLLOW_IDENT_in_value343 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NUMBER_in_value350 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_value357 = new BitSet(new long[]{0x0000000000080000L});
	public static final BitSet FOLLOW_19_in_value359 = new BitSet(new long[]{0x0000000000004230L});
	public static final BitSet FOLLOW_unary_in_value361 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_16_in_value363 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_value370 = new BitSet(new long[]{0x0000000000100000L});
	public static final BitSet FOLLOW_20_in_value372 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_NUMBER_in_value376 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_NUMBER_in_value380 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_16_in_value382 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_value389 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_IDENT_in_value390 = new BitSet(new long[]{0x0000000000010200L});
	public static final BitSet FOLLOW_9_in_value393 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_IDENT_in_value396 = new BitSet(new long[]{0x0000000000010010L});
	public static final BitSet FOLLOW_16_in_value400 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_16_in_value403 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_14_in_value410 = new BitSet(new long[]{0x0000000000004630L});
	public static final BitSet FOLLOW_component_in_value412 = new BitSet(new long[]{0x0000000000004630L});
	public static final BitSet FOLLOW_component_in_value414 = new BitSet(new long[]{0x0000000000004630L});
	public static final BitSet FOLLOW_component_in_value416 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_16_in_value418 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_component434 = new BitSet(new long[]{0x0000000000800000L});
	public static final BitSet FOLLOW_23_in_component435 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_IDENT_in_component437 = new BitSet(new long[]{0x0000000000004230L});
	public static final BitSet FOLLOW_value_in_component439 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_16_in_component440 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_component447 = new BitSet(new long[]{0x0000000000004630L});
	public static final BitSet FOLLOW_component_in_component450 = new BitSet(new long[]{0x0000000000014630L});
	public static final BitSet FOLLOW_16_in_component454 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_value_in_component459 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IDENT_in_unary476 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NUMBER_in_unary483 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_value_in_unary490 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_Z3ERROR_in_error503 = new BitSet(new long[]{0x0000000000000002L});
}
