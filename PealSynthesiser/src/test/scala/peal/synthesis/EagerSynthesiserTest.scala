...
class EagerSynthesiserTest extends ShouldMatchersForJUnit with Z3ModelMatcher {
  ...
  def testCanDealWithDefaultInput() {
    ...
    output should beZ3Model("(declare-const q5 Bool)\n" +
      ...
      "(echo \"Result of vacuity check [vct_cond1 = always_true? cond1]:\")\n(push)\n(declare-const always_true_vct_cond1 Bool)\n(assert (= always_true_vct_cond1 cond1))\n(assert (not always_true_vct_cond1))\n(check-sat)\n(get-model)\n(pop)\n" +
      "(echo \"Result of vacuity check [vcf_cond1 = always_false? cond1]:\")\n(push)\n(declare-const always_false_vcf_cond1 Bool)\n(assert (= always_false_vcf_cond1 cond1))\n(assert always_false_vcf_cond1)\n(check-sat)\n(get-model)\n(pop)\n" +
      "(echo \"Result of vacuity check [vct_cond2 = always_true? cond2]:\")\n(push)\n(declare-const always_true_vct_cond2 Bool)\n(assert (= always_true_vct_cond2 cond2))\n(assert (not always_true_vct_cond2))\n(check-sat)\n(get-model)\n(pop)\n" +
      "(echo \"Result of vacuity check [vcf_cond2 = always_false? cond2]:\")\n(push)\n(declare-const always_false_vcf_cond2 Bool)\n(assert (= always_false_vcf_cond2 cond2))\n(assert always_false_vcf_cond2)\n(check-sat)\n(get-model)\n(pop)\n" +
      "(echo \"Result of vacuity check [vct_cond3 = always_true? cond3]:\")\n(push)\n(declare-const always_true_vct_cond3 Bool)\n(assert (= always_true_vct_cond3 cond3))\n(assert (not always_true_vct_cond3))\n(check-sat)\n(get-model)\n(pop)\n" +
      "(echo \"Result of vacuity check [vcf_cond3 = always_false? cond3]:\")\n(push)\n(declare-const always_false_vcf_cond3 Bool)\n(assert (= always_false_vcf_cond3 cond3))\n(assert always_false_vcf_cond3)\n(check-sat)\n(get-model)\n(pop)\n" +
      "(echo \"Result of vacuity check [vct_cond4 = always_true? cond4]:\")\n(push)\n(declare-const always_true_vct_cond4 Bool)\n(assert (= always_true_vct_cond4 cond4))\n(assert (not always_true_vct_cond4))\n(check-sat)\n(get-model)\n(pop)\n" +
      "(echo \"Result of vacuity check [vcf_cond4 = always_false? cond4]:\")\n(push)\n(declare-const always_false_vcf_cond4 Bool)\n(assert (= always_false_vcf_cond4 cond4))\n(assert always_false_vcf_cond4)\n(check-sat)\n(get-model)\n(pop)\n" +
