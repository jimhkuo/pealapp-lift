...
class MaxLessThanThTest extends ShouldMatchersForJUnit {
  ...
  def testCanSynthesisNestedMoreCase() {
    ...
    phi2.synthesis(z3,consts) should be("(and (and q1 q1) (and (and q1 q1) (or (not q2) q2)))")
    z3.delete()
  }
...
//    println(phi2.synthesis)
    phi2.synthesis(z3,consts) should be("(and (and q1 q1) (or (not q2) q2))")
    z3.delete()
  }
  ...
  def testCanSynthesisSimpleCase() {
    ...
    phi.synthesis(z3,consts) should be("(and (and q1 q1) (or (not q2) q2))")
    z3.delete()
  }
}
