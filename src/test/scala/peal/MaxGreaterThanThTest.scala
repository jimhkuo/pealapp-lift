...
class MaxGreaterThanThTest extends ShouldMatchersForJUnit {
  ...
  def testCanSynthesisSimpleCase() {
    ...
    val phi = new MaxGreaterThanTh(p1, p2, 0.6)

    phi.synthesis should be("(and (or (not q1) (not q1)) (or false (not q2)))")
  }
}
