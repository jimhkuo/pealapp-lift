...
class MinLessThanThTest extends ShouldMatchersForJUnit {
  ...
  def testCanSynthesisNestedCase() {
    ...
    phi2.synthesis(z3) should be("(or (and q1 q1) (or (and q1 q1) (or (not q2) q2)))")
    z3.delete()
  }
  ...
  def testCanSynthesisSimpleNestedCase() {
    ...
    phi2.synthesis(z3) should be("(or (and q1 q1) (or (not q2) q2))")
    z3.delete()
  }
  ...
  def testCanSynthesisSimpleCase() {
    ...
    phi.synthesis(z3) should be("(or (and q1 q1) (or (not q2) q2))")
    z3.delete()
  }
}
