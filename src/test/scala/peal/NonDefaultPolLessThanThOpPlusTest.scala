...
class NonDefaultPolLessThanThOpPlusTest extends ShouldMatchersForJUnit {
  ...
  //    val pSet = new NonDefaultPolLessThanThOpPlus(p, 0.6)
  //    //M1 is the whole set
  ...
  //    val pSet = new NonDefaultPolLessThanThOpPlus(p, 0.5)
  //
