...
class ThLessThanMinTest extends ShouldMatchersForJUnit with Z3ModelMatcher {
  ...
  def testCanSynthesisSimpleNestedCase() {
    ...
    phi2.synthesis(z3, consts) should beZ3Model("(and (or (not q1) (not q1)) (and q2 (not q2)))")
  }
  ...
  def testCanSynthesisSimpleCase() {
    ...
    phi.synthesis(z3, consts) should beZ3Model("(and (or (not q1) (not q1)) (and q2 (not q2)))")
  }
}
